     ...
     <BackNavigation 
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          <PageHeader 
            title="Inscrivez-vous en tant que"
            subtitle="Trouvez les meilleurs enseignants pour accompagner la réussite scolaire de vos enfants"
            brandName="Parent"
            // brandColor="blue"
            // iconColor="blue"
          />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div className="lg:col-span-1 order-2 lg:order-1">
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xs p-8  dark:border-gray-700">
            ...
            <div className="lg:col-span-2 order-1 lg:order-2">
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xs  dark:border-gray-700 overflow-hidden">
                {/* En-tête formulaire */}
                <div className="bg-blue-600 px-8 py-6 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      <h2 className="text-2xl text-blue-100 font-bold">Créez votre compte parent</h2>
                      <p className="text-blue-100">Trouvez le professeur idéal en quelques minutes</p>
                    </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6  dark:border-gray-700 hover:shadow-xs transition-shadow">
          ...
          <div className="mb-12">
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-6 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
                  <div className="bg-white dark:bg-gray-800 rounded-xl p-5  dark:border-gray-700">
